...
int upload(CURL *curlhandle, const char * remotepath, const char * localpath, long timeout, long tries)
{
    ...
    curl_easy_setopt(curlhandle, CURLOPT_USERPWD, "ftpdemo:123456");
    curl_easy_setopt(curlhandle, CURLOPT_PORT, 22);
    if (timeout)
...
int main(int c, char **argv)
{
    ...
    upload(curlhandle, "ftp://10.0.0.2/CentOS-6.5-x86_64-bin-DVD2.iso", "D:/CentOS-6.5-x86_64-bin-DVD1.iso", 1, 3);
//    download(curldwn, "ftp://10.0.0.2/CentOS-6.5-x86_64-bin-DVD1.iso", "D:/CentOS-6.5-x86_64-bin-DVD1.iso", 1, 3);
